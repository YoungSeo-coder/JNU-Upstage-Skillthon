...
2. **Aggregate into benchmark** — run the aggregation script from the solar-skill-creator directory:
   ```bash
...
4. **Launch the viewer** with both qualitative outputs and quantitative data:
   ```bash
   nohup python <solar-skill-creator-path>/eval-viewer/generate_review.py \
