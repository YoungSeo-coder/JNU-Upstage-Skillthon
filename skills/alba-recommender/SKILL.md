...
전남대 인근 5개 상권 업체의 **누적 유저 리뷰**를 9개 객관 기준으로 분석하여 클린지수를 동적 산출하고, 조건에 맞는 알바를 추천한다.
...
$$\text{클린지수} = 100 - \sum_{i=1}^{9} \left(\frac{\text{위반 언급 수}_i}{\text{전체 리뷰 수}} \times \frac{100}{9}\right)$$

- 항목당 최대 배점: **11.11점** (100 ÷ 9)
...
| 8 | 동시간대 업무자 부족 | 적정 동시간대 업무자 배치 |
| 9 | 초과근무 급여 미지급 | 초과근무 급여 지급 |
